...
namespace Microsoft.AspNetCore.Blazor.Razor
{
    internal class BindTagHelperDescriptorProvider : ITagHelperDescriptorProvider
    {
        ...
        public void Execute(TagHelperDescriptorProviderContext context)
        {
            ...
            //      generate the 'value' attribute and 'changed' attribute. 
            //
        ...
        private List<TagHelperDescriptor> CreateElementBindTagHelpers(List<ElementBindData> data)
        {
            ...
            for (var i = 0; i < data.Count; i++)
            {
                ...
                var formatName = entry.Suffix == null ? "Format" : "Format_" + entry.Suffix;
                var formatAttributeName = entry.Suffix == null ? "format" : "format-" + entry.Suffix;
